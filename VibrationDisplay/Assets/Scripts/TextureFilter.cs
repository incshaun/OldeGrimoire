// From: http://wiki.unity3d.com/index.php/TextureFilter
...
public static class TextureFilter
{
  ...
  private static void Filter(Texture2D inTex, Texture2D outTex, FilterMethod method, params object[] parameters)
  {
  ...
  #region Grayscale
  public static void Grayscale(Texture2D inTex, Texture2D outTex)
  {
    Filter(inTex, outTex, GrayscaleFunc);
  }
  ...
  #region Threshold
  public static void Threshold(Texture2D inTex, Texture2D outTex, float threshold)
  {
    Filter(inTex, outTex, ThresholdFunc, threshold);
  }
  ...
  public static void Convolution(Texture2D inTex, Texture2D outTex, float[][] kernel, int iteration)
  {
    Filter(inTex, outTex, ConvolutionFunc, kernel, iteration);
  }
  ...
  #region Sepia
  public static void Sepia(Texture2D inTex, Texture2D outTex)
  {
    Filter(inTex, outTex, SepiaFunc);
  }
  ...
  public static void ContrasteSaturationBrightness(Texture2D inTex, Texture2D outTex, float contrast, float saturation, float brightness)
  {
    Filter(inTex, outTex, ContrasteSaturationBrightnessFunc, saturation, brightness, contrast);
  }
  ...
  #region SobelFilter
  public static void SobelFilter(Texture2D inTex, Texture2D outTex)
  {  
    Filter(inTex, outTex, SobelFilterFunc);
  }
